// UID map
const uidToPageMap = {
    "miyuki.html": ["435C47BF"],
    "eventmiyuki.html": ["435C47BF"], 
};

// Elements
const miyukiButton = document.getElementById("kleeButton");
...
miyukiButton.addEventListener("click", () => {
    targetPage = "miyuki.html"; // Set halaman target ke Klee
    startNFCScan(); // Mulai scan NFC
});

// Tombol untuk membuka halaman Kalender
calendarButton.addEventListener("click", () => {
    targetPage = "eventmiyuki.html"; // Set halaman target ke Kalender
    startNFCScan(); // Mulai scan NFC
});
